...
import WorkspaceHelpPage from "./page";
...
describe("/app/help page", () => {
  ...
  it("renders workspace-aware Help Center signals and product lane links", async () => {
      ...
      products: [
        {
          product: {
            ...
            name: "Help Pilot",
            summary: "Guided product lane for testing Help content.",
    ...
    const html = renderToStaticMarkup(await WorkspaceHelpPage());

    expect(html).toContain("Workspace-aware operating guide");
    expect(html).toContain("Workspace guide");
    expect(html).toContain("Triage CRM pressure");
    expect(html).toContain("CRM attention");
    expect(html).toContain("Factory Lab");
    expect(html).toContain("founder@example.com");
    expect(html).toContain("Help Pilot");
    expect(html).toContain("Launch gate passed");
    expect(html).toContain("Pending analysis");
